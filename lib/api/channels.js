...
class Channels {
    ...
    info({ roomId, roomName }, callback) {
        return idOrNameRequest.bind(this)({ id: { roomId }, name: { roomName } }, "channels.info", callback);
    }
    ...
    roles({ roomId, roomName }, callback) {
        return idOrNameRequest.bind(this)({ id: { roomId }, name: { roomName } }, "channels.roles", callback);
    }
