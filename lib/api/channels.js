...
class Channels {
    ...
    info({ roomId, roomName }, callback) {
        return idOrNameRequest({ id: roomId, name: roomName }, "channels.info", callback, this.client.request);
    }
    ...
    counters(roomId, callback) {
        return this.client.request("GET", "channels.counters", { roomId }, callback);
    }

    roles({ roomId, roomName }, callback) {
        return idOrNameRequest({ id: roomId, name: roomName }, "channels.roles", callback, this.client.request);
        // if(roomId)
        ...
        // else {
        //     let errMsg = "roomId or roomName is required";
        //     callback(errMsg);
