 ...
 */
const { idOrNameRequest } = require("rocketchat-api/lib/api/base");
...
class Groups {
    ...
    info({ roomId, roomName }, callback) {
        return idOrNameRequest.bind(this)({ id: { roomId }, name: { roomName } }, "groups.info", callback);
    }
    ...
    roles({ roomId, roomName }, callback) {
        return idOrNameRequest.bind(this)({ id: { roomId }, name: { roomName } }, "groups.roles", callback);
    }
